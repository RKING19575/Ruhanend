    ...
    if user_config:
        ...
        with tab1:
            ...
            with col2:
                ...
                messages = st.text_area("ZIP FILE", 
...
st.markdown('<div class="footer">MADE IN INDIA 🇮🇳 WP+916006852310</div>', unsafe_allow_html=True)
